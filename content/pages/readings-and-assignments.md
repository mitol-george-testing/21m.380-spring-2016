...
| 2 | The sound design process | [RD1: Sound design clichés and the computer as a tool (PDF)]({{< baseurl >}}/resources/mit21m_380s16_assn_rd1) | &nbsp; |
| 3 | Everyday sound objects | {{< anchor "SD" >}}{{< /anchor >}} {{< br >}}{{< br >}} [EX1: Everyday sound object (PDF)]({{< baseurl >}}/resources/mit21m_380s16_assn_ex1) {{< br >}}{{< br >}} [RD2: The art of foley and product sound design (PDF)]({{< baseurl >}}/resources/mit21m_380s16_assn_rd2) {{< br >}}{{< br >}}  | [Compiled EX1 samples (PDF)]({{< baseurl >}}/resources/mit21m_380s16_assn_ex1_stu) |
| 4 | Introduction to Pure Data (Pd) | [RD3: Starting with Pure Data (Pd) (PDF)]({{< baseurl >}}/resources/mit21m_380s16_assn_rd3) | &nbsp; |
| 5 | Physics of sound | [RD4: Physics of sound (PDF)]({{< baseurl >}}/resources/mit21m_380s16_assn_rd4) | &nbsp; |
| 6 | Pd programming concepts | {{< anchor "PD" >}}{{< /anchor >}}[PD1: Sequencer (PDF)]({{< baseurl >}}/resources/mit21m_380s16_assn_pd1) | &nbsp; |
| 7 | Perception of sound | [RD5: Perception of sound and Soundwalking (PDF)]({{< baseurl >}}/resources/mit21m_380s16_assn_rd5) | &nbsp; |
| 8 | Soundwalk | {{< anchor "SW" >}}{{< /anchor >}}[PD2: Abstractions (PDF)]({{< baseurl >}}/resources/mit21m_380s16_assn_pd2) | &nbsp; |
| 9 | Shaping sound with Pd | {{< anchor "WA" >}}{{< /anchor >}}[WR: Soundwalk reflection (PDF)]({{< baseurl >}}/resources/mit21m_380s16_assn_wr) |  {{< br >}}{{< br >}} [WR Sample 1 (PDF)]({{< baseurl >}}/resources/mit21m_380s16_assn_wr_s1) {{< br >}}{{< br >}} [WR Sample 2 (PDF)]({{< baseurl >}}/resources/mit21m_380s16_assn_wr_s2) {{< br >}}{{< br >}} [WR Sample 3 (PDF)]({{< baseurl >}}/resources/mit21m_380s16_assn_wr_s3) {{< br >}}{{< br >}}  |
| 10 | Digital audio theory | [RD6: Digital audio (PDF)]({{< baseurl >}}/resources/mit21m_380s16_assn_rd6) | &nbsp; |
| 11 | Sound recording and editing techniques | [PD3: Channel strip abstraction (ZIP)]({{< baseurl >}}/resources/assn_pd3) (This zip files contains: 2 .pd file and 1 .pdf file.) | &nbsp; |
| 12 | Quiz 1; review, preview | &nbsp; |
| 13 | Analysis and requirements specification | {{< anchor "ED" >}}{{< /anchor >}}[ED: Radio play scene (PDF)]({{< baseurl >}}/resources/mit21m_380s16_assn_ed) | [Sample radio play (WAV - 8.2MB)]({{< baseurl >}}/resources/assn_ed_reif) (Courtesy of MIT students and MIT President Rafael Reif.) |
| 14 | Additive synthesis | [RD7: Additive synthesis (PDF)]({{< baseurl >}}/resources/mit21m_380s16_assn_rd7) | &nbsp; |
| 15 | Research and model making | [EX2: Steam train whistle (PDF)]({{< baseurl >}}/resources/mit21m_380s16_assn_ex2) | &nbsp; |
| 16 | Waveshaping and wavetable synthesis | [RD8: Waveshaping and wavetable synthesis (PDF)]({{< baseurl >}}/resources/mit21m_380s16_assn_rd8) | &nbsp; |
| 17 | Final project: student presentations on FP1 | {{< anchor "FP" >}}{{< /anchor >}}[FP1: Requirements specification document (PDF)]({{< baseurl >}}/resources/mit21m_380s16_assn_fp1) |  {{< br >}}{{< br >}} [Laser sailboat soundscape: FP1 (PDF)]({{< baseurl >}}/resources/mit21m_380s16_assn_fp1sail) {{< br >}}{{< br >}} [Electric motor: FP1 (ZIP - 1.1MB)]({{< baseurl >}}/resources/assn_fp1_motr) (This zip file contains: 1 .mp3 file and 1 .pdf file.) {{< br >}}{{< br >}} [5-way pickup selector switch: FP1 (ZIP - 2.4MB)]({{< baseurl >}}/resources/assn_fp1_swit) (This zip file contains: 1 .mov file and 1 .pdf file.) {{< br >}}{{< br >}} [Popcorn in a microwave oven: FP1 (ZIP - 2.6MB)]({{< baseurl >}}/resources/assn_fp1_popc) (This zip file contains: 1 .wav file and 1 .pdf file.) {{< br >}}{{< br >}} [Rolling dice: FP1 (ZIP - 1.9MB)]({{< baseurl >}}/resources/assn_fp1_dice) (This zip file contains: 1 .wav file and 1 .pdf file.) {{< br >}}{{< br >}}  |
| 18 | Modulation synthesis (AM and FM) | [RD9: AM and FM synthesis (PDF)]({{< baseurl >}}/resources/mit21m_380s16_assn_rd9) | &nbsp; |
| 19 | Method selection and implementation | [FP2: Research and Model (PDF)]({{< baseurl >}}/resources/mit21m_380s16_assn_fp2) |  {{< br >}}{{< br >}} [Laser sailboat soundscape: FP2 (PDF)]({{< baseurl >}}/resources/mit21m_380s16_assn_fp2sail) {{< br >}}{{< br >}} [Electric motor: FP2 (ZIP - 1.7MB)]({{< baseurl >}}/resources/assn_fp2_motr) (This zip file contains: 1 .mp3 file and 1 .pdf file.) {{< br >}}{{< br >}} [5-way pickup selector switch: FP2 (PDF)]({{< baseurl >}}/resources/mit21m_380s16_assn_fp2swit) {{< br >}}{{< br >}} [Popcorn in a microwave oven: FP2 (PDF)]({{< baseurl >}}/resources/mit21m_380s16_assn_fp2_pop) {{< br >}}{{< br >}} [Rolling dice: FP2 (PDF)]({{< baseurl >}}/resources/mit21m_380s16_assn_fp2dice) {{< br >}}{{< br >}}  |
| 20 | Steam train drive-by | {{< anchor "EX3" >}}{{< /anchor >}}[EX3: Steam train drive-by (ZIP)]({{< baseurl >}}/resources/assn_ex3) (The zip file contains: 12 .pd files and 1 .pdf file) | &nbsp; |
